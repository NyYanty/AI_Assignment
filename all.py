...
import csv
reader = csv.DictReader(open("prototype.csv"))
for raw in reader:
    print(raw)
...
import csv
with open('prototype.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

    #way to write to csv file
    writer.writerow(['Name', 'Age', 'Section'])
    writer.writerow(['Chhunneng', '21', 'C'])
    writer.writerow(['Sokon', '18', 'B'])
    writer.writerow(['Vichea', '18', 'C'])
    writer.writerow(['Piseth', '19', 'A'])
    writer.writerow(['KimHun', '20', 'C'])
    writer.writerow(['Daro', '19', 'C'])
